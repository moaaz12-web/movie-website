...
const Latest_URL = BASE_URL + '/movie/now_playing?' + API_KEY + '&language=en-US&page=1'

// https://api.themoviedb.org/3/movie/latest??&api_key=f536ce9a181c3ab1e48ec40c2747b4cd&language=en-US&page=1
...
function Latest() {
    ...
    return (
        <>
        <Navbar/>
        <p id="id-for-latest" data-aos="zoom-in">Just Released</p>
